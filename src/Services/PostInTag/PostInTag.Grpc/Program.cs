...
using PostInTag.Grpc.Extensions;
using Serilog;
...
try
{
    ...
    builder.WebHost.ConfigureKestrel(options =>
    {
        ...
        {
            options.ListenAnyIP(5107, listenOptions => listenOptions.Protocols = HttpProtocols.Http2);
        }
        ...
        if (builder.Environment.IsLocal() || builder.Environment.IsStaging())
        {
            ...
            options.ListenAnyIP(6107, listenOptions => listenOptions.Protocols = HttpProtocols.Http2);
        }
    });
