...
try
{
    ...
    builder.WebHost.ConfigureKestrel(options =>
    {
        ...
        {
            options.ListenAnyIP(5102, listenOptions => listenOptions.Protocols = HttpProtocols.Http2);
        }
        ...
        if (builder.Environment.IsLocal())
        {
            ...
            options.ListenAnyIP(6102, listenOptions => listenOptions.Protocols = HttpProtocols.Http2);
        }
    });
