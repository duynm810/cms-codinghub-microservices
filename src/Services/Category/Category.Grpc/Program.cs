...
try
{
    ...
    builder.WebHost.ConfigureKestrel(options =>
    {
        ...
        {
            options.ListenAnyIP(5004, listenOptions => listenOptions.Protocols = HttpProtocols.Http2);
        }
        ...
        if (builder.Environment.IsEnvironment(EnvironmentConsts.Local))
        {
            ...
            options.ListenAnyIP(6004, listenOptions => listenOptions.Protocols = HttpProtocols.Http2);
        }
    });
