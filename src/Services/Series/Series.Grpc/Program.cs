...
try
{
    ...
    builder.WebHost.ConfigureKestrel(options =>
    {
        ...
        {
            options.ListenAnyIP(5104, listenOptions => listenOptions.Protocols = HttpProtocols.Http2);
        }
        ...
        if (builder.Environment.IsEnvironment(EnvironmentConsts.Local))
        {
            ...
            options.ListenAnyIP(6104, listenOptions => listenOptions.Protocols = HttpProtocols.Http2);
        }
    });
