...
try
{
    ...
    builder.WebHost.ConfigureKestrel(options =>
    {
        ...
        {
            options.ListenAnyIP(5106, listenOptions => listenOptions.Protocols = HttpProtocols.Http2);
        }
        ...
        if (builder.Environment.IsEnvironment(EnvironmentConsts.Local))
        {
            ...
            options.ListenAnyIP(6106, listenOptions => listenOptions.Protocols = HttpProtocols.Http2);
        }
    });
