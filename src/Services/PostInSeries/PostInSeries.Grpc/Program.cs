...
using PostInSeries.Grpc.Extensions;
using Serilog;
...
try
{
    ...
    builder.WebHost.ConfigureKestrel(options =>
    {
        ...
        {
            options.ListenAnyIP(5105, listenOptions => listenOptions.Protocols = HttpProtocols.Http2);
        }
        ...
        if (builder.Environment.IsLocal() || builder.Environment.IsStaging())
        {
            ...
            options.ListenAnyIP(6105, listenOptions => listenOptions.Protocols = HttpProtocols.Http2);
        }
    });
