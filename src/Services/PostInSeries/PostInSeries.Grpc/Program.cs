...
try
{
    ...
    builder.WebHost.ConfigureKestrel(options =>
    {
        ...
        {
            options.ListenAnyIP(5013, listenOptions => listenOptions.Protocols = HttpProtocols.Http2);
        }
        ...
        if (builder.Environment.IsEnvironment(EnvironmentConsts.Local))
        {
            ...
            options.ListenAnyIP(6013, listenOptions => listenOptions.Protocols = HttpProtocols.Http2);
        }
    });
